	...
	<body>
		...
		<div class="admin-content">
			<div class="admin-content-body">
				<div class="am-g">
					<form action="../updateshopsale" class="am-form am-form-horizontal"
						 method="post"
						...
						<div class="am-form-group">
							...
							产品ID</label>
							<div class="am-u-sm-9">
								<input type="text" id="doc-vld-pwd-1" readonly="readonly" required placeholder=<%=id %>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input type="text" id="doc-vld-pwd-2" required placeholder=<%=number %> 
									name="number"  data-equal-to="#doc-vld-pwd-1"  required value=<%=number %>> <small>输入销售数量。</small>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">
							...
							<div class="am-u-sm-9">
								<input type="date" id="doc-vld-pwd-2" required placeholder=<%=date %> 
									name="date"  data-equal-to="#doc-vld-pwd-1"  required value=<%=date %>> <small>输入销售日期。</small>
							</div>
						</div>
