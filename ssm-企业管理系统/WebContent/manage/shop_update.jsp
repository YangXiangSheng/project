						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input type="text" id="doc-vld-pwd-1" required readonly="readonly" placeholder=<%=id %>
									name="s_id" value=<%=id %>> <small>输入产品ID。</small>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">
								产品名称</label>
							<div class="am-u-sm-9">
								<input type="text" id="doc-vld-pwd-2" required placeholder=<%=name %>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input type="text" id="doc-vld-pwd-2" required placeholder=<%=number %> 
									name="number"  data-equal-to="#doc-vld-pwd-1"  required value=<%=number %>> <small>输入库存数量。</small>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">
							...
							<input type="text" id="doc-vld-pwd-2" required placeholder="暂无设定价格"
									name="price"  data-equal-to="#doc-vld-pwd-1" > <small>输入产品价格。</small>
						   	<%}else{ %>
								<input type="text" id="doc-vld-pwd-2" required placeholder=<%= price %> 
									name="price"  data-equal-to="#doc-vld-pwd-1"  required value=<%=price %>> <small>输入产品价格。</small>
							<%}%>
							</div>
						</div>
						<div class="am-form-group">
