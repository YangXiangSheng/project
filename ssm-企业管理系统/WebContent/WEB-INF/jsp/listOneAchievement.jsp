				...
				<div class="am-u-sm-12">
					<form class="am-form">
						<table class="am-table am-table-striped am-table-hover table-main">
							...
							<c:forEach items="${Achievement}" var="achievement"><tbody>
									...
									<td>
										<div class="am-btn-toolbar">
											<div class="am-btn-group am-btn-group-xs">
												...
												<button  type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="window.location.href='deleteAchievement?date=${achievement.date }'"><span class="am-icon-trash-o" ></span> 删除</button>
											</div>
										</div>
									</td>
								</tr>
