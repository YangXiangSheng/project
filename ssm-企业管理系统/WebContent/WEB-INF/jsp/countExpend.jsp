            ...
            <button class="am-btn am-btn-default" type="submit" id="submitBtn" >搜索某一天的支出</button>
				...
				<form   action="countExpend" method="post" enctype="multipart/form-data">
					<div class="am-input-group am-input-group-sm">
						...
						name="date">
						<span class="am-input-group-btn">
            <button class="am-btn am-btn-default" type="submit" id="submitBtn" >搜索某一月的支出</button>
          </span>
					</div>
				</form>
				</div>
						...
						<table class="am-table am-table-striped am-table-hover table-main">
							<thead>
								<tr>
									...
									<th class="table-set">本月支出</th>
								</tr>
							</thead>
							<c:forEach items="${CountExpend}" var="countExpend"><tbody>
							
								<tr>
									<td >${countExpend.year}</td>
									<td >${countExpend.month}</td>
									<td>${countExpend.expenditure}元</td>
									<td>
