...
public class RedisController {
    ...
    public Map<String,Object> testStringAndHash(){
        ...
        stringRedisTemplate.opsForValue().set("init","1");
        //使用运算
    ...
    public Map<String, Object> testMulti() {
        ...
        List<Object> list= (List<Object>) redisTemplate.execute(new SessionCallback<List<Object>>() {
            ...
            public List<Object> execute(RedisOperations redisOperations) throws DataAccessException{
                ...
                redisOperations.opsForValue().increment("key1",1);//increment("key1", 1);// ①
    ...
    public Map<String, Object> testPipeline() {
       ...
       List<Object> list=(List<Object>) redisTemplate.executePipelined(new SessionCallback<Object>() {
           @Override
